...
public class HBaseDaoUtil {
    ...
    public static void main(String args[]){
       log.info("++++++++++++++++++++++++++"+getRowKey("cfbcaf92-545a-11e9-a22d-6c92bf48d254-31",1557740486441L));
    }
    ...
    private void modifyTable(String tableName,Set<String> familyColumn) {
        ...
        try (Admin admin = HconnectionFactory.connection.getAdmin();) {
            ...
            for (String fc : familyColumn) {
                HColumnDescriptor hcd = new HColumnDescriptor(fc);
//                if(tableName.equals("product_show_prod")){
...
//                }else {
    ...
    public void deleteTimeRange(String tableName, Long minTime, Long maxTime) {
        ...
        try {
            ...
            connection = HconnectionFactory.connection;
